...
let tasks = [
	...
	{users: ["Phil", "Chris"], name: "Critique Task Manager Demo", description: "Come up with a list of improvements.", datetime:"2022-07-14T14:30", datetimeformat: "July 14, 2022 @ 14:30", priority: "Medium", status: "Backlog"}
]
